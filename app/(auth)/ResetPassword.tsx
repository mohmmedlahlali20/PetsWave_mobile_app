    ...
    switch (currentStep) {
      ...
      case 'password':
        return (
          <View className="space-y-4">
            <TextInput
              className="border border-gray-200 rounded-xl px-4 py-3 bg-white text-gray-800 m-5"
            ...
            >
              {isLoading ? (
                ...
                <Text className="text-lg font-semibold text-white text-center">Réinitialiser</Text>
              )}
            </TouchableOpacity>
          </View>
        );
      ...
      case 'success':
        return (
          <View className="items-center space-y-4">
            ...
            >
              <Text className="text-lg font-semibold text-white text-center">Se connecter</Text>
            </TouchableOpacity>
          </View>
        );
    }
